    ...
    <div className="overflow-hidden">
      ...
      <section className="py-20 px-6 md:px-20 bg-white text-center">
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto text-left ">
          <motion.div
            className="bg-gray-100 p-2 rounded-sm shadow-lg shadow-gray-200 transition-all duration-300 ease-in-out hover:scale-102"
            variants={fadeUp}
            custom={1}
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <section className="bg-gray-50 py-20 px-6 md:px-20">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-bold mb-4 text-blue-700">A Message from Our Headteacher</h2>
            ...
            <p className="font-semibold text-gray-700">– Mrs. Sarah Johnson</p>
            <p className="text-sm text-gray-500">Headteacher</p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-5 gap-8 max-w-6xl mx-auto">
          {[
            ...
            <motion.div
              ...
              whileInView="visible"
              viewport={{ once: true }}
              className="flex flex-col items-center text-center bg-gray-50 rounded-2xl p-6 shadow hover:shadow-md transition"
            >
        ...
        <div className="grid md:grid-cols-4 gap-6 max-w-6xl mx-auto">
          {schoolAdmins.map((admin, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="overflow-hidden rounded-2xl shadow hover:shadow-lg transition-all duration-300 ease-in-out hover:scale-102">
                <img src={admin.image} alt={`Staff ${admin.name}`} className="w-full h-56 object-cover" />
                <CardContent className="p-4">
                  <h4 className="font-semibold text-blue-700">Teacher {admin.name}</h4>
